			...
			if (settings.items < length) {
				...
				if (settings.arrows) {
					slider.find('.krakatoa-control').append('<div class="arrows">' +
						'<a class="arrow arrow-left" data-direction="-1" href="#"><i class="material-icons">keyboard_arrow_left</i></a>' +
						'<a class="arrow arrow-right" data-direction="1" href="#"><i class="material-icons">keyboard_arrow_right</i></a>' +
						'</div>');
